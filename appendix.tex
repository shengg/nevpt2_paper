...
The operators $a_i$ and $a^\dagger_j$ are permuted, so the orbitals indices not decrease. Only the permutation between two operators with different orbital indices are needed.
